...
public class PdfGenerator {
    ...
    public static byte[] generateReceiptPdf(Student student, ReceiptResponse receipt, PaymentDetail payment) {
        try (ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream()) {
            ...
            // **Fee Details Table**
            Table feeTable = new Table(new float[]{1, 5, 4}).useAllAvailableWidth();
            ...
            // **Fee Data**
            addFeeRow(feeTable, "1.", "Admission Fee", "0");
            addFeeRow(feeTable, "2.", "Prospectus Fee", "0");
            addFeeRow(feeTable, "3.", "Tuition Fee", String.valueOf(receipt.getAmountPaid()));
            addFeeRow(feeTable, "4.", "Previous Dues", "0");
            addFeeRow(feeTable, "5.", "Other Fee", "0");
